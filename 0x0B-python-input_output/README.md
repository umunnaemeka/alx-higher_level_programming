# Python Input/Output
Project done during **Full Stack Software Engineering studies** at **ALX Software Engineering School**. It aims to learn how to open, read, write and append files from a script in **Python**.
