...
Project done during **Full Stack Software Engineering studies** at **Alx Software Engineering School**. It aims to learn about docstrings to create and implement tests in **Python**.
